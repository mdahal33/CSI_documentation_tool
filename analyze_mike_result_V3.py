...
def get_optimized_parameters(sqfile_dir, calibrated_parameters, c_name, RDII_name):
    ...
    c_name: Name of the basin or catchment whose optimized parameters need to be extracted.
    
    RDII_name: Name of the RDII basin whose optimized parameters need to be extracted.
...
def create_graph(model_date, model_y, flow_met_date, flow_met_y, diurn_date, diurn_y, rain_date, rain_y,
                 ...
                 scenario_name,event_name,model_dir, basin_name):
    """
...
def main():
    ...
    for i in range(0, len(adf_event_data)):
        ...
        met_list2 = compute_metrics(flow_adf_filt, qdf_adf_filt, save_interpolated_graph, model_dir, event_name)
    ...
    optimized_parm = get_optimized_parameters(sqfiledir , calibrated_parameters, c_name, RDII_name)
